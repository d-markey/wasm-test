...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      }(A._callDartFunctionFast1, t4);
      result[$.$get$DART_CLOSURE_PROPERTY_NAME()] = t4;
      t3.onmessage = result;
      t2._as(t1.self).postMessage("READY");
    },
  ...
  A.main_closure.prototype = {
    call$1(e) {
      var data, ktypes, vtypes, e0, itypes, e1, ex, t2, t3, t4, exception,
        t1 = type$.JSObject;
      t1._as(e);
      try {
        data = A.dartify(e.data);
        if (data instanceof A.MapBase) {
          t2 = type$.String;
          ktypes = A.LinkedHashSet_LinkedHashSet$_empty(t2);
          vtypes = A.LinkedHashSet_LinkedHashSet$_empty(t2);
          for (t2 = data.get$entries(), t3 = A._instanceType(t2), t2 = new A.MappedIterator(J.get$iterator$ax(t2.__internal$_iterable), t2._f, t3._eval$1("MappedIterator<1,2>")), t3 = t3._rest[1]; t2.moveNext$0();) {
            t4 = t2.__internal$_current;
            e0 = t4 == null ? t3._as(t4) : t4;
            J.add$1$ax(ktypes, A._rtiToString(J.get$runtimeType$(e0.key)._rti, null));
            J.add$1$ax(vtypes, A._rtiToString(J.get$runtimeType$(e0.value)._rti, null));
          }
          t1._as(self.self).postMessage(A.getRuntimeTypeOfDartObject(data).toString$0(0) + " with keys: " + A.S(ktypes) + " and values: " + A.S(vtypes));
        } else if (type$.List_dynamic._is(data)) {
          itypes = A.LinkedHashSet_LinkedHashSet$_empty(type$.String);
          for (t2 = J.get$iterator$ax(data); t2.moveNext$0();) {
            e1 = t2.get$current();
            J.add$1$ax(itypes, A._rtiToString(J.get$runtimeType$(e1)._rti, null));
          }
          t1._as(self.self).postMessage(J.get$runtimeType$(data).toString$0(0) + " with items: " + A.S(itypes));
        } else
          t1._as(self.self).postMessage(J.get$runtimeType$(data).toString$0(0));
      } catch (exception) {
        ex = A.unwrapException(exception);
        t2 = self;
        t1._as(t2.self).postMessage("ERROR: " + A.S(ex));
      }
    },
    $signature: 13
  };
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._Zone, A._HashMapKeyIterator, A.SetBase, A._LinkedHashSetCell, A._LinkedHashSetIterator, A.ListBase, A.DateTime, A.StackOverflowError, A._Exception, A.MapEntry, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException]);
