...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    callWorker(worker, message) {
      return A.callWorker$body(worker, message);
    },
    callWorker$body(worker, message) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.dynamic),
        $async$returnValue, t1, completer, t2;
      var $async$callWorker = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = new A.callWorker_$error(completer);
              worker.onmessage = A._functionToJS1(new A.callWorker_closure(worker, A.Timer_Timer$periodic(B.Duration_180000000, new A.callWorker_closure0(t2, message)), t2, new A.callWorker_$success(completer)));
              worker.postMessage(A.jsify(message));
    ...
    startWorker(url) {
      var $async$goto = 0,
        ...
        $async$returnValue, worker, t1;
      var $async$startWorker = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              worker = type$.JSObject._as(new self.Worker(url));
              t1 = new A._Future($.Zone__current, type$._Future_dynamic);
              worker.onmessage = A._functionToJS1(new A.startWorker_closure(new A._AsyncCompleter(t1, type$._AsyncCompleter_dynamic)));
              $async$goto = 3;
              return A._asyncAwait(t1, $async$startWorker);
            case 3:
              // returning from await.
              worker.onmessage = null;
              $async$returnValue = worker;
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$startWorker, $async$completer);
    },
    callWorker_$success: function callWorker_$success(t0) {
      this.completer = t0;
    },
    callWorker_$error: function callWorker_$error(t0) {
      this.completer = t0;
    },
    callWorker_closure0: function callWorker_closure0(t0, t1) {
      this.$$error = t0;
      this.message = t1;
    },
    callWorker_closure: function callWorker_closure(t0, t1, t2, t3) {
      var _ = this;
      _.worker = t0;
      _.timeout = t1;
      _.$$error = t2;
    ...
    startWasmWorker_closure: function startWasmWorker_closure(t0) {
      this.url = t0;
    },
    startWorker_closure: function startWorker_closure(t0) {
      this.ready = t0;
    },
    ...
    Logger__esc(message) {
      var t1 = A.stringReplaceAllUnchecked(message, "&", "&amp;");
      t1 = A.stringReplaceAllUnchecked(t1, "<", "&lt;");
      return A.stringReplaceAllUnchecked(t1, ">", "&gt;");
    },
    Logger_trace(message) {
      var t1 = type$.JSObject,
        output = type$.nullable_JSObject._as(t1._as(self.document).querySelector("#output"));
      if (output == null)
        output = t1._as(output);
      output.innerHTML = A.S(type$.Object._as(output.innerHTML)) + '<span class="log trace">[TRACE] ' + A.Logger__esc(message) + "</span><br/>";
    },
    Logger_info(message) {
      var t1 = type$.JSObject,
        output = type$.nullable_JSObject._as(t1._as(self.document).querySelector("#output"));
      if (output == null)
        output = t1._as(output);
      t1 = type$.Object;
      if (B.JSString_methods.trim$0(message).length === 0)
        output.innerHTML = A.S(t1._as(output.innerHTML)) + "<br/>";
      else
        output.innerHTML = A.S(t1._as(output.innerHTML)) + '<span class="log info">[INFO] ' + A.Logger__esc(message) + "</span><br/>";
    },
    Logger_error(message) {
      ...
      if (output == null)
        output = t1._as(output);
      output.innerHTML = A.S(type$.Object._as(output.innerHTML)) + '<span class="log error">[ERROR] ' + A.Logger__esc(message) + "</span><br/>";
    },
    main() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$currentError, $async$next = [], ex, ex0, exception, t1, worker, $async$exception, $async$exception1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              worker = null;
              $async$handler = 3;
              A.Logger_trace("Loading JS Web worker...");
              $async$goto = 6;
              return A._asyncAwait(A.startWorker("/worker/worker.dart.js"), $async$main);
            case 6:
              // returning from await.
              worker = $async$result;
              A.Logger_trace("JS Web worker is ready, running tests...");
              $async$goto = 7;
              return A._asyncAwait(A.runTests(worker), $async$main);
            case 7:
              // returning from await.
              $async$next.push(5);
              // goto finally
            ...
            case 3:
              ...
              A.Logger_error("CAUGHT EXCEPTION: " + A.S(ex));
              $async$next.push(5);
              // goto finally
              $async$goto = 4;
              break;
            ...
            case 4:
              // finally
              $async$handler = 1;
              A.Logger_trace("Terminating JS Web worker...");
              t1 = worker;
              if (t1 != null)
                t1.terminate();
              worker = null;
            ...
            case 5:
              ...
              A.Logger_info("");
              $async$handler = 9;
              A.Logger_trace("Loading WASM Web worker...");
              $async$goto = 12;
              return A._asyncAwait(A.startWasmWorker(), $async$main);
            case 12:
              // returning from await.
              worker = $async$result;
              A.Logger_trace("WASM Web worker is ready, running tests...");
              $async$goto = 13;
              return A._asyncAwait(A.runTests(worker), $async$main);
            case 13:
              // returning from await.
            ...
            case 9:
              ...
              A.Logger_error("CAUGHT EXCEPTION: " + A.S(ex0));
              $async$next.push(11);
              // goto finally
              $async$goto = 10;
              break;
            ...
            case 10:
              // finally
              $async$handler = 1;
              A.Logger_trace("Terminating WASM Web worker...");
              t1 = worker;
              if (t1 != null)
                t1.terminate();
              worker = null;
    ...
    runTests(worker) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, t2, msg, res;
      var $async$runTests = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.callWorker(worker, "This is a test"), $async$runTests);
            case 2:
              // returning from await.
              res = $async$result;
              A.Logger_info("Sent " + A.createRuntimeType(type$.String).toString$0(0) + ' "' + "This is a test" + '", worker received ' + A.S(res));
              $async$goto = 3;
              return A._asyncAwait(A.callWorker(worker, 5), $async$runTests);
            case 3:
              // returning from await.
              res = $async$result;
              t1 = type$.int;
              A.Logger_info("Sent " + A.createRuntimeType(t1).toString$0(0) + ' "' + 5 + '", worker received ' + A.S(res));
              $async$goto = 4;
              return A._asyncAwait(A.callWorker(worker, 3.141592653589793), $async$runTests);
            case 4:
              // returning from await.
              res = $async$result;
              t2 = type$.double;
              A.Logger_info("Sent " + A.createRuntimeType(t2).toString$0(0) + ' "' + A.S(3.141592653589793) + '", worker received ' + A.S(res));
              msg = A._setArrayType(["Posting", "a", "list"], type$.JSArray_String);
              $async$goto = 5;
              return A._asyncAwait(A.callWorker(worker, msg), $async$runTests);
            case 5:
              // returning from await.
              res = $async$result;
              A.Logger_info("Sent " + A.createRuntimeType(A._arrayInstanceType(msg)).toString$0(0) + ' "' + A.S(msg) + '", worker received ' + A.S(res));
              msg = A.LinkedHashMap_LinkedHashMap$_literal([1, 125], t1, t2);
              $async$goto = 6;
              return A._asyncAwait(A.callWorker(worker, msg), $async$runTests);
            case 6:
              // returning from await.
              res = $async$result;
              A.Logger_info("Sent " + A.getRuntimeTypeOfDartObject(msg).toString$0(0) + ' "' + msg.toString$0(0) + '", worker received ' + A.S(res));
              t2 = type$.bool;
              msg = A.LinkedHashMap_LinkedHashMap$_literal([true, false, false, true], t2, t2);
              $async$goto = 7;
              return A._asyncAwait(A.callWorker(worker, msg), $async$runTests);
            case 7:
              // returning from await.
      ...
      return A._asyncStartSync($async$runTests, $async$completer);
    }
  },
  B = {};
  var holders = [A, J, B];
  ...
  A.callWorker_$success.prototype = {
    call$1(data) {
  ...
  A.callWorker_closure0.prototype = {
    call$1(t) {
      type$.Timer._as(t).cancel$0();
      this.$$error.call$1(new A.TimeoutException("ERROR: timeout for " + A.S(this.message)));
    },
    $signature: 16
  };
  A.callWorker_closure.prototype = {
    call$1(e) {
      var t1, data, _this = this;
      type$.JSObject._as(e);
      _this.worker.onmessage = null;
      t1 = _this.timeout;
      if (t1._handle != null) {
        t1.cancel$0();
        data = A.dartify(e.data);
        if (typeof data == "string" && B.JSString_methods.startsWith$1(data, "ERROR"))
          _this.$$error.call$1(data);
        else
          _this.$$success.call$1(data);
      }
    },
    $signature: 6
  };
  A.startWasmWorker_closure.prototype = {
    call$0() {
      self.URL.revokeObjectURL(this.url);
    },
    $signature: 2
  };
  A.startWorker_closure.prototype = {
    call$1(e) {
      var t1 = this.ready;
      if (J.$eq$(A.dartify(type$.JSObject._as(e).data), "READY"))
        t1.complete$0();
      else
        t1.completeError$1("Unexpected message");
    },
    $signature: 6
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.SentinelValue, A.Iterable, A.ListIterator, A.MappedIterator, A.FixedLengthListMixin, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapBase, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A.AsyncError, A.TimeoutException, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A._StreamIterator, A._Zone, A._HashMapKeyIterator, A.ListBase, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.NullRejectionException]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A.jsify__convert, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.dartify_convert, A.callWorker_$success, A.callWorker_$error, A.callWorker_closure0, A.callWorker_closure, A.startWorker_closure]);
